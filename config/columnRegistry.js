const salonOwnerRegistry = [
  ...
  { key: 'gst_number', label: 'GST Number', path: 'gst_number', type: 'string' },
  { key: 'status', label: 'Status', path: 'status', type: 'string' },
  { key: 'owner_name', label: 'Owner Name', path: 'user.name', type: 'string' },
  { key: 'owner_email', label: 'Owner Email', path: 'user.email', type: 'string' },
...
const serviceCategoryRegistry = [
  ...
  { key: 'sort_order', label: 'Sort Order', path: 'sort_order', type: 'number' },
  { key: 'status', label: 'Status', path: 'status', type: 'string' },
  { key: 'created_at', label: 'Created At', path: 'created_at', type: 'date' },
];

const serviceRegistry = [
  { key: 'service_name', label: 'Service', path: 'service_name', type: 'string' },
...
const bookingRegistry = [
  { key: 'booking_number', label: 'Booking #', path: 'booking_number', type: 'string' },
  { key: 'customer_name', label: 'Customer', path: 'customer.user.name', type: 'string' },
  { key: 'salon_name', label: 'Salon', path: 'salon.salon_name', type: 'string' },
  { key: 'service_name', label: 'Service', path: 'service.service_name', type: 'string' },
  { key: 'booking_date', label: 'Date', path: 'booking_date', type: 'date' },
  { key: 'booking_status', label: 'Status', path: 'booking_status', type: 'string' },
];
...
const couponRegistry = [
  ...
  { key: 'discount_type', label: 'Type', path: 'discount_type', type: 'string' },
  { key: 'discount_value', label: 'Value', path: 'discount_value', type: 'number' },
...
const bannerRegistry = [
  ...
  { key: 'redirect_type', label: 'Redirect Type', path: 'redirect_type', type: 'string' },
  { key: 'sort_order', label: 'Sort Order', path: 'sort_order', type: 'number' },
  { key: 'status', label: 'Status', path: 'status', type: 'string' },
];
...
const rolesRegistry = [
  { key: 'name', label: 'Name', path: 'name', type: 'string' },
  { key: 'hierarchy_level', label: 'Hierarchy', path: 'hierarchy_level', type: 'number' },
  { key: 'is_active', label: 'Active', path: 'is_active', type: 'boolean' },
  { key: 'created_at', label: 'Created At', path: 'created_at', type: 'date' },
];
