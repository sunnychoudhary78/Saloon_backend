...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable({ schema, tableName: 'addresses' }, {
    ...
    await queryInterface.addIndex({ schema, tableName: 'addresses' }, ['employee_id']);
  },
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable({ schema, tableName: 'addresses' });
  }
};
